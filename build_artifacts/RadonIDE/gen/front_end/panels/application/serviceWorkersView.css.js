...
styles.replaceSync(
`.service-worker-version{display:flex;flex-wrap:wrap;devtools-button{margin-left:var(--sys-size-3)}}.service-worker-version-stack{position:relative}.service-worker-version-stack-bar{position:absolute;top:10px;bottom:20px;left:4px;content:"";border-left:1px solid var(--sys-color-divider);z-index:0}.service-worker-version:not(:last-child){margin-bottom:7px}.service-worker-version-string{flex-shrink:0}.service-worker-active-circle,
