import"../../../../ui/legacy/legacy.js";import*as e from"../../../../core/i18n/i18n.js";import*as t from"../../../../core/platform/platform.js";import"../../../../ui/components/buttons/buttons.js";import*as a from"../../../../ui/components/input/input.js";import*as r from"../../../../ui/lit-html/lit-html.js";import*as n from"../../../../ui/visual_logging/visual_logging.js";import*as i from"../utils/utils.js";const s=new CSSStyleSheet;s.replaceSync('.root{color:var(--sys-color-on-surface);width:100%}.tree-title{font-weight:700;display:flex;align-items:center}.rotate-icon{transform:rotate(90deg)}.form-container{display:grid;grid-template-columns:1fr 1fr 1fr auto;align-items:center;column-gap:10px;row-gap:8px;padding:0 10px}.full-row{grid-column:1/5}.half-row{grid-column:span 2}.mobile-checkbox-container{display:flex}.device-model-input{grid-column:1/4}.input-field{color:var(--sys-color-on-surface);padding:3px 6px;border-radius:2px;border:1px solid var(--sys-color-neutral-outline);background-color:var(--sys-color-cdt-base-container);font-size:inherit;height:18px}.input-field:focus{border:1px solid var(--sys-color-state-focus-ring);outline-width:0}.add-container{cursor:pointer;display:flex;align-items:center;gap:6px}.add-icon{margin-right:5px}.brand-row{display:flex;align-items:center;gap:10px;justify-content:space-between}.brand-row > input{width:100%}.info-icon{margin-left:5px;margin-right:1px}.link,\n.devtools-link{color:var(--sys-color-primary);text-decoration:underline;cursor:pointer;outline-offset:2px;font-weight:400}devtools-icon + .link{margin-inline-start:2px}.hide-container{display:none}.input-field-label-container{display:flex;flex-direction:column;gap:10px}@media (forced-colors: active){.input-field{border:1px solid}.tree-title[aria-disabled="true"]{color:GrayText}}\n/*# sourceURL=userAgentClientHintsForm.css */\n');const{html:l}=r,o={title:"User agent client hints",useragent:"User agent (Sec-CH-UA)",fullVersionList:"Full version list (Sec-CH-UA-Full-Version-List)",brandProperties:"User agent properties",brandName:"Brand",brandNameAriaLabel:"Brand {PH1}",significantBrandVersionPlaceholder:"Significant version (e.g. 87)",brandVersionPlaceholder:"Version (e.g. 87.0.4280.88)",brandVersionAriaLabel:"Version {PH1}",addBrand:"Add Brand",brandUserAgentDelete:"Delete brand from user agent section",brandFullVersionListDelete:"Delete brand from full version list",fullBrowserVersion:"Full browser version (Sec-CH-UA-Full-Browser-Version)",fullBrowserVersionPlaceholder:"Full browser version (e.g. 87.0.4280.88)",platformLabel:"Platform (Sec-CH-UA-Platform / Sec-CH-UA-Platform-Version)",platformProperties:"Platform properties",platformVersion:"Platform version",platformPlaceholder:"Platform (e.g. Android)",architecture:"Architecture (Sec-CH-UA-Arch)",architecturePlaceholder:"Architecture (e.g. x86)",deviceProperties:"Device properties",deviceModel:"Device model (Sec-CH-UA-Model)",mobileCheckboxLabel:"Mobile",update:"Update",notRepresentable:"Not representable as structured headers string.",userAgentClientHintsInfo:"User agent client hints are an alternative to the user agent string that identify the browser and the device in a more structured way with better privacy accounting.",addedBrand:"Added brand row",deletedBrand:"Deleted brand row",learnMore:"Learn more"},d=e.i18n.registerUIStrings("panels/settings/emulation/components/UserAgentClientHintsForm.ts",o),c=e.i18n.getLocalizedString.bind(void 0,d);class h extends Event{static eventName="clienthintschange";constructor(){super(h.eventName)}}class u extends Event{static eventName="clienthintssubmit";detail;constructor(e){super(u.eventName),this.detail={value:e}}}const p={brands:[{brand:"",version:""}],fullVersionList:[{brand:"",version:""}],fullVersion:"",platform:"",platformVersion:"",architecture:"",model:"",mobile:!1};class b extends HTMLElement{#e=this.attachShadow({mode:"open"});#t=!1;#a=!1;#r=p;#n=!1;#i=!1;#s="";connectedCallback(){this.#e.adoptedStyleSheets=[a.checkboxStyles,s]}set value(e){const{metaData:t=p,showMobileCheckbox:a=!1,showSubmitButton:r=!1}=e;this.#r={...this.#r,...t},this.#n=a,this.#i=r,this.#l()}get value(){return{metaData:this.#r}}set disabled(e){this.#a=e,this.#t=!1,this.#l()}get disabled(){return this.#a}#o=e=>{"Space"!==e.code&&"Enter"!==e.code&&"ArrowLeft"!==e.code&&"ArrowRight"!==e.code||(e.stopPropagation(),this.#d(e.code))};#d=e=>{this.#a||"ArrowLeft"===e&&!this.#t||"ArrowRight"===e&&this.#t||(this.#t=!this.#t,this.#l())};#c=(e,t,a)=>{const r=this.#r.brands?.map(((r,n)=>{if(n===t){const{brand:t,version:n}=r;return"brandName"===a?{brand:e,version:n}:{brand:t,version:e}}return r}));this.#r={...this.#r,brands:r},this.dispatchEvent(new h),this.#l()};#h=(e,t,a)=>{const r=this.#r.fullVersionList?.map(((r,n)=>{if(n===t){const{brand:t,version:n}=r;return"brandName"===a?{brand:e,version:n}:{brand:t,version:e}}return r}));this.#r={...this.#r,fullVersionList:r},this.dispatchEvent(new h),this.#l()};#u=e=>{const{brands:t=[]}=this.#r;t.splice(e,1),this.#r={...this.#r,brands:t},this.dispatchEvent(new h),this.#s=c(o.deletedBrand),this.#l();let a=this.shadowRoot?.getElementById(`ua-brand-${e+1}-input`);a||(a=this.shadowRoot?.getElementById("add-brand-button")),a?.focus()};#p=e=>{const{fullVersionList:t=[]}=this.#r;t.splice(e,1),this.#r={...this.#r,fullVersionList:t},this.dispatchEvent(new h),this.#s=c(o.deletedBrand),this.#l();let a=this.shadowRoot?.getElementById(`fvl-brand-${e+1}-input`);a||(a=this.shadowRoot?.getElementById("add-fvl-brand-button")),a?.focus()};#b=()=>{const{brands:e}=this.#r;this.#r={...this.#r,brands:[...Array.isArray(e)?e:[],{brand:"",version:""}]},this.dispatchEvent(new h),this.#s=c(o.addedBrand),this.#l();const t=this.shadowRoot?.querySelectorAll(".ua-brand-name-input");if(t){const e=Array.from(t).pop();e&&e.focus()}};#m=e=>{"Space"!==e.code&&"Enter"!==e.code||(e.preventDefault(),this.#b())};#g=()=>{const{fullVersionList:e}=this.#r;this.#r={...this.#r,fullVersionList:[...Array.isArray(e)?e:[],{brand:"",version:""}]},this.dispatchEvent(new h),this.#s=c(o.addedBrand),this.#l();const t=this.shadowRoot?.querySelectorAll(".fvl-brand-name-input");if(t){const e=Array.from(t).pop();e&&e.focus()}};#f=e=>{"Space"!==e.code&&"Enter"!==e.code||(e.preventDefault(),this.#g())};#v=(e,t)=>{e in this.#r&&(this.#r={...this.#r,[e]:t},this.#l()),this.dispatchEvent(new h)};#$=e=>{"Space"!==e.code&&"Enter"!==e.code||(e.preventDefault(),e.target.click())};#w=e=>{e.preventDefault(),this.#i&&(this.dispatchEvent(new u(this.#r)),this.#l())};#x(e,a,r,i){return l`
    ...
    `}#D(){const{platform:e,platformVersion:t}=this.#r;return l`
      <span class="full-row label">${c(o.platformLabel)}</span>
      <div class="full-row brand-row" aria-label=${c(o.platformProperties)} role="group">
        <input
          class="input-field half-row"
          type="text"
          @input=${e=>{const t=e.target.value;this.#v("platform",t)}}
          .value=${e}
          placeholder=${c(o.platformPlaceholder)}
          aria-label=${c(o.platformLabel)}
        ...
        <input
          ...
          .value=${t}
          placeholder=${c(o.platformVersion)}
          aria-label=${c(o.platformVersion)}
          jslog=${n.textField("platform-version").track({change:!0})}
        />
      </div>
    `}#A(){const{model:e,mobile:t}=this.#r,a=this.#n?l`
      <label class="mobile-checkbox-container">
        ...
        />
        ${c(o.mobileCheckboxLabel)}
      </label>
    `:l``;return l`
      <span class="full-row label">${c(o.deviceModel)}</span>
      <div class="full-row brand-row" aria-label=${c(o.deviceProperties)} role="group">
        <input
          class="input-field ${this.#n?"device-model-input":"full-row"}"
          type="text"
          @input=${e=>{const t=e.target.value;this.#v("model",t)}}
          .value=${e}
          placeholder=${c(o.deviceModel)}
          jslog=${n.textField("model").track({change:!0})}
        />
        ${a}
      </div>
    `}#k(){const{brands:e=[{brand:"",version:""}]}=this.#r,t=e.map(((e,t)=>{const{brand:a,version:r}=e,i=()=>{this.#u(t)};return l`
        <div class="full-row brand-row" aria-label=${c(o.brandProperties)} role="group">
          <input
            ...
            placeholder=${c(o.brandName)}
            aria-label=${c(o.brandNameAriaLabel,{PH1:t+1})}
          ...
          <input
            ...
            .value=${r}
            placeholder=${c(o.significantBrandVersionPlaceholder)}
            aria-label=${c(o.brandVersionAriaLabel,{PH1:t+1})}
            jslog=${n.textField("brand-version").track({change:!0})}
          />
          <devtools-icon
            .data=${{color:"var(--icon-default)",iconName:"bin",width:"16px",height:"16px"}}
            title=${c(o.brandUserAgentDelete)}
            class="delete-icon"
            tabindex="0"
            role="button"
            @click=${i}
            @keypress=${e=>{"Space"!==e.code&&"Enter"!==e.code||(e.preventDefault(),i())}}
            aria-label=${c(o.brandUserAgentDelete)}
          >
          </devtools-icon>
        </div>
      `}));return l`
      <span class="full-row label">${c(o.useragent)}</span>
      ${t}
      <div
    ...
    `}#y(){const{fullVersionList:e=[{brand:"",version:""}]}=this.#r,t=e.map(((e,t)=>{const{brand:a,version:r}=e,i=()=>{this.#p(t)};return l`
        <div
          class="full-row brand-row"
          aria-label=${c(o.brandProperties)}
          ...
          <input
            ...
            .value=${r}
            placeholder=${c(o.brandVersionPlaceholder)}
            aria-label=${c(o.brandVersionAriaLabel,{PH1:t+1})}
            jslog=${n.textField("brand-version").track({change:!0})}
          />
          <devtools-icon
            .data=${{color:"var(--icon-default)",iconName:"bin",width:"16px",height:"16px"}}
            title=${c(o.brandFullVersionListDelete)}
            class="delete-icon"
            tabindex="0"
            role="button"
            @click=${i}
            @keypress=${e=>{"Space"!==e.code&&"Enter"!==e.code||(e.preventDefault(),i())}}
            aria-label=${c(o.brandFullVersionListDelete)}
          >
          </devtools-icon>
        </div>
      `}));return l`
      <span class="full-row label">${c(o.fullVersionList)}</span>
      ${t}
      <div
        class="add-container full-row"
        role="button"
    ...
    `}#l(){const{fullVersion:e,architecture:t}=this.#r,a=this.#k(),i=this.#y(),s=this.#x(c(o.fullBrowserVersion),c(o.fullBrowserVersionPlaceholder),e||"","fullVersion"),d=this.#D(),h=this.#x(c(o.architecture),c(o.architecturePlaceholder),t,"architecture"),u=this.#A(),p=this.#i?l`
      <devtools-button
        .variant=${"outlined"}
        .type=${"submit"}
      >
      ...
      <section class="root">
        ...
        >
          ...
          <devtools-icon
            ...
            title=${c(o.userAgentClientHintsInfo)}
            class='info-icon'
          ></devtools-icon>
          <x-link
           tabindex=${this.#a?"-1":"0"}
           ...
           class="link"
           @keypress=${this.#$}
           aria-label=${c(o.userAgentClientHintsInfo)}
